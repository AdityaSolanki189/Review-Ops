...
export function ProfileForm({ session }: ProfileFormProps) {
    ...
    async function handleUnlinkAccount(provider: Provider) {
        try {
            ...
            if (!unlinkAccountId) {
                toast.error('Account ID not found for unlinking')
                setIsUnlinking(null)
                return
            }
                                            ...
                                            <form onSubmit={nameForm.handleSubmit(onUpdateName)} className="space-y-6">
                                                ...
                                                <div className="flex gap-3 pt-3">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="flex-1"
                                                        disabled={
                                                            isUpdatingName || nameForm.watch('name') === userData.name
                                                        }
                                                    >
                                                        {isUpdatingName && (
                            ...
                            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                                ...
                                >
                                    ...
                                    <DialogContent className="sm:max-w-[400px]">
                                        ...
                                        <Form {...imageForm}>
                                            <form
                                                onSubmit={imageForm.handleSubmit(onUpdateImage)}
                                                className="space-y-6"
                                            >
                                                <div className="flex flex-col items-center space-y-6">
                                                    ...
                                                    />
                                                    <FormMessage>
                                                        {imageForm.formState.errors.profileImage?.message}
                                                    </FormMessage>
                                                </div>
                                                <div className="flex gap-3 pt-3">
                                                    <Button
                                                    ...
                                                    <Button
                                                        type="submit"
                                                        className="flex-1"
                                                        disabled={!imagePreview || isUpdatingImage}
                                                    >
                                                        {isUpdatingImage && (
                                                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                                        )}
