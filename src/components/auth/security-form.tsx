...
export function SecurityForm({ session, activeSessions }: SecurityFormProps) {
    ...
    const maskEmail = (email: string) => {
        ...
        const maskedDomain = '*'.repeat(Math.max(0, domain.length - 4)) + domain.slice(-4)
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Need to recover access? We&apos;ll send you a password reset link.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex items-center justify-between">
                        ...
                        <Dialog open={isResetPasswordDialogOpen} onOpenChange={setIsResetPasswordDialogOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        For security, please confirm your email address. We&apos;ll send you a link to
                                        reset your password.
                                    </DialogDescription>
                                </DialogHeader>
